...
# 2. رسالة مني ليكي (التعديل الجديد)
with st.expander("💌 دي رسالة مني ليكي (افتحيها)"):
    ...
    متزعليش مني لو في يوم من الايام زعلتك عايزك تسمحيني هه 🥲🙈😔✋ يا رخمة انتي عارفة اكيد بيكون في سبب انتي كنتي رخمة بردو الاه 🥹💗
    
    هنخلي الموقع ده بينا نحط فيه ذكريات ونحتفل بعيد ميلادك سنين كتيرة.. حبيت اول واحد يقولك كل سنة وانتي طيبة يا ميمو، العمر كله ليكي ويكون خير عليكي وتحققي كل حاجة نفسك فيها بحبك 💗🎉❤️
    """)
